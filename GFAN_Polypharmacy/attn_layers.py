...
# Initialization variables required: n_heads, hid_units, zero_list, ffd_drop, attn_drop, activation, residual
# Call variables required: seq = inputs, bias_mat = bias_mat
